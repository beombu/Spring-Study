...
public class MemberApiController {
    ...
    public CreateMemberResponse saveMemberV2(@RequestBody @Valid CreateMemberRequest request) {//Entitiy가 변해도 API spec은 변하지 않는다는 장점을 가진다.
    ...
    static class CreateMemberRequest {
        @NotEmpty//DTO에서 validation 처리할 것
        private String name;
    }
